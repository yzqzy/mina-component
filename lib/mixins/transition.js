...
var getClassNames = function (name) { return ({
    enter: "mina-".concat(name, "-enter mina-").concat(name, "-enter-active enter-class enter-active-class"),
    'enter-to': "mina-".concat(name, "-enter-to mina-").concat(name, "-enter-active enter-to-class enter-active-class"),
    leave: "mina-".concat(name, "-leave mina-").concat(name, "-leave-active leave-class leave-active-class"),
    'leave-to': "mina-".concat(name, "-leave-to mina-").concat(name, "-leave-active leave-to-class leave-active-class"),
}); };
