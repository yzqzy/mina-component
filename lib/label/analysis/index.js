...
(0, component_1.MinaComponent)({
    ...
    methods: {
        ...
        drawImageLayout: function (image) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, dpr, basicLayout, width, height, _b, canvas, ctx_1, img_1, _c, error_1;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            _b = _d.sent(), canvas = _b.canvas, ctx_1 = _b.ctx;
                            this.setData({
                                'canvasNodes.image': { canvas: canvas, ctx: ctx_1 },
                            });
                            img_1 = canvas.createImage();
                            _c = img_1;
                            return [4 /*yield*/, (0, tool_1.getRealPath)(image.image_url)];
                        case 3:
                            _c.src = _d.sent();
